...
Aromas a Santiago manta`,
  ...
  {
    title: "Para los ojos más bellos",
    slug: "para-los-ojos-mas-bellos",
    author: "Juan Carlos Carabajal",
    letra: `
G                   D7        G
Lunita alumbramé con tus destellos
C                  A7            D7
y ayudame a encontrar sus ojos tan bellos,
             C        D7         G
lunita ayudamé que sueño con ellos.
...
porqué tuvo que ser tan cruel el destino.

ESTRIBILLO:
Y cuando sola estés con mi recuerdo
no te olvides mi bien que mucho te quiero
y esperandoté están mis brazos abiertos.
...
podamos corazón borrar las heridas
...
el fruto de tu amor y tanto cariño.`,
  },
  {
...
La vida me han prestao y tengo que devolverla       *
  LA       SI                    LA                 *
cuando el creador me llame para la entrega          * ESTRIBILLO
DO#7            FA#m          DO#7         FA#m     *
que mis huesos, piel y sal abonen mi suelo natal.   *


INTERLUDIO: DO#7 , FA#m  x4            ("segunda")
...
del monte chaqueño
  ...
  {
    title: "De esas que te hacen llorar",
    slug: "de-esas-que-te-hacen-llorar",
    author: "Jorge Rojas",
    letra: `
   A
...
Am                               C
Dentro del rancho colgado a un horcón
           G7              C
...
Am                             C
Un hornito de barro montero y fogón
        G7           C
Tengo además tengo además
            E              Am            
Y mi negra chura que sabe matear
           E           Am
Para que más para que más

            C              Em
Si alguna huanita pudiera tener
         F             E
...
¡Claro que sí!, ¡claro si pues!
  ...
  {
    title: "Que lindo es estar de vuelta",
    slug: "que-lindo-es-estar-de-vuelta",
    author: "Los Nocheros",
    letra: `
Am                 F              G            C
Cuando suenan los violines el corazon se me alegra
    Dm                  Am        F            E7
que lindo es estar de vuelta, querido patio de tierra
   Dm             Am             E7       Am
debajo de la enrramada cantando una chacarera

Parece que los recuerdos han echo nido en el alma
y te canto viejo patio en el que solia mi mama
pedir de la de nosotros, para bailar una zamba

Lugar de grandes encuentros es lo que dicen y es cierto
tus años tienen historias, como estrellas tiene el cielo
lo churo que nunca faltan cantores y guitarreros

Cuando suenan los violines el corazon se me alegra
que lindo es estar de vuelta, querido patio de tierra
debajo de la enrramada cantar una chacarera

que si de cantar se trata voy a cumplir con las ganas
no soy de los que se achican, si me acercan la guitarra
se pasar la noche entera sin mezquinar la garganta

si al alba se oye un coplero con la tonada chaqueña
un grito fuerte del pecho, me brota por la querencia
y el que alejo del pago quiere volver a su tierra

no voy a ponerme triste por todo lo ya sabido
pa todos estan las penas, pa todos esta el olvido
prefiero cantar alegre para seguir el camino
...
`,
  ...
  {
    title: "La mochita negra",
    slug: "la-mochita-negra",
    author: "Lazaro Caballero",
    letra: `
    INTRO: MI7 - LA
...
`,
  ...
  {
    title: "Te sigo recordando",
    slug: "te-sigo-recordando",
    author: "Lazaro Caballero",
    letra: `
    A
Como me cuesta aceptar,
                     D
que otros labios te besó,
                    SIm
que tu cuerpo se entregó,
  E                A
a otro hombre en silencio.
...
que te olvidaste de mí,
               SIm
tus celos te hizo así,
E                    A
tu orgullo me hace sufrir.

E          D           A
Igual, te sigo recordando,
E          D                   A
yo fuí, feliz estando en tus brazos,
E          D           A
y así te olvido lentamente,
E          D           A
...
A
Como me cuesta esconder,
                   D
mi sufrimiento y dolor,
                  SIm
no encuentro la solución,
  E                A
me voy cayendo en lo peor.

A
Como me cuesta olvidar,
                     D
lo bueno de nuestro amor,
                   SIm
aunque me duele tu error,
  E               A
...
tenerte lejos me hace bien.`,
  ...
  {
    title: "Del tiempo de mi niñez",
    slug: "del-tiempo-de-mi-ninez",
    author: "Cuti y Roberto Carabajal",
    letra: `
      LA  SOL    FA  MI7
...
Que lejos que queda ahora...`,
  ...
  {
    title: "Firme como el quebracho",
    slug: "firme-como-el-quebracho",
    author: "Christian Herrera y Matacos",
    letra: `
    INTRO : DO  SOL  RE7 x3

Mismos acordes siempre
...
Ya retosa el bagual balan chivas
Y el ritual de coquear me da vida

ESTRIBILLO:
soy rigor y algarrobo del chaco
Pal que hacer firme como el quebracho

Silbando pal corral voy dispuesto
Enlazar al serril pampa viejo
...
ESTRIBILLO:`,
  ...
  {
    title: "Chacarera de mis sueños",
    slug: "chacarera-de-mis-suenos",
    author: "Los Manseros Santiagueños",
    letra: `
    DO - SOL  - FA - DO SOL - DO
...
no levanta vuelo`,
  ...
  {
    title: "De peña en peña",
    slug: "de-pena-en-pena",
    author: "Lazaro Caballero",
    letra: `
      E
...
Soy candil de noche larga
Y me hacen bulla en el pecho
Los sones de mi guitarra   [BIS]
...
Si me anda tanteando el alma
   B7        A7    E
El duende del diapazon
E                     F#m
Soy pentagrama y me vuelvo
         B7          E   E7 
De peña en peña cantor
A                 E
Crespin de la madrugada
         B7          E
De peña en peña cantor

[Interludio] E  A  E  A  E  B7  E
             E  A  E  A  E  B7  E  B7  E  B7  E

Como el lucero que alumbra
Yo canto de peña en peña
Y en la noche mas oscura
Sabe alumbrarme una estrella   [BIS]

Mi guitarra amiga guarda
Una caricia escondida
Y anda buscando en la zamba
Tu mirada presumida   [BIS]

[Estribillo]`,
  },
  {
    title: "Que me has hecho chacarera",
    slug: "que-me-has-hecho-chacarera",
    author: "Juan Onofre",
    letra: `
    MI7 LAm MI7 LAm
LAm RE LA RE MI7
...
vivias contenta y pura
como el coyuyo en la rama.

Siguiendo tus pasos iba
debajo los ramadones
cuando inquietaba los viejos
y a changuitos corazones


Ahora que no te escucho
lejos del pago querido
veni veni chacarera
porque aqui penando vivo


En mis sueños yo me encuentro
Pechando por las trincheras
cantando con mis paisanos
vidalas y chacareras

Ay junita quien pudiera
...
porque aqui penando vivo.`,
  ...
  {
    title: "Luz de mis ojos",
    slug: "luz-de-mis-ojos",
    author: "Los Manseros Santiagueños",
    letra: `
    LAm           DO 
En cuanto te vi
...
Deja que tu luz...`,
  ...
  {
    title: "Semilla de chacarera",
    slug: "semilla-de-chacarera",
    author: "Los Manseros Santiagueños",
    letra: `
    Intro: B7 Em B7 Em D G B7 Em B7 Em

 G                                              D
Cuando te aprieto a mi pecho y me iluminas el alma
 Am                                         Em
Pueden saber de tu tiempo de tu raíz y tus entrañas
                       D           B7           Em
Cuando te aprieto a mi pecho y me iluminas el alma

(Intro)

As de volver a la vida en los primero acordes
Y cerraras las heridas del hacha cruel de los hombres
As de volver a la vida en los primeros acordes
...
Quiero sembrar en tu caja semilla de chacarera
Guitarra dame tu magia para cantarle a mi tierra
...
Hay si pudiera contarme bien despacito al oído
La afinación de las aves y acentito del rio
Hay si pudiera contarme bien despacito al oído

(Intro)

Cuando se seque mi árbol quiero tenerte tu destino
...
se espacio junto a tu tierra
mi morena, piel chaquena, mi vergel


Am                                       G
Al llamar el corcel, ese potro de tu corazón

sin frenar si pasión
                            Am
se fue al campo verde del amor


Am                                      G
Al mirar el manjar es la fruta de tu corazón
...
2ª parte con acordes de la primera estrofa


El poema de tus besos
los leí dentro de tu alma
y en las quietas mansas agua de cristal


Sos arco iris de mis días
en sí la lluvia del verano
y en mis manos fue la noche un trajinar
...
FIN: Am - G - Am`,
  ...
  {
    title: "Caballo que no galopa",
    slug: "caballo-que-no-galopa",
...
MI caballito querido...`,
  ...
  {
    title: "Mi nueva primavera",
    slug: "mi-nueva-primavera",
    author: "Los Manseros Santiagueños",
    letra: `
    A
A F#m D E
...
Y de mi alma una nueva primavera
                             E
Que ha poblado de trigo mi existir
        D                     E
...
En esos tus ojos dulces quiero mirarme
              E             D                     A           A  E  A
Por siempre amor, mi gran amor por sieeeeeempre amor`,
  },
  {
    title: "Dejame que me vaya",
    slug: "dejame-que-me-vaya",
    author: "Chaqueño Palavecino",
    letra: `
    Am
...
A olvidarme tus besos
----------------------
A donde iré, no importa     todas las demas iguales a la
No intentes detenerme             primera estrofa
Total, sabes de sobra    |
Que en vano fue quererte |bis
-------------------------
No creo en tus promesas
No me hagas juramentos
No bien tu voz los suelta |
Ya se los lleva el viento |bis
------------------------
ESTRIBILLO
