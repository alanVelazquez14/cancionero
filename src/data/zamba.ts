export const zambas = [
  {
    title: "Zamba de amor en vuelo",
    slug: "zamba-de-amor-en-vuelo",
    author: "Tamara Castro",
    letra: `
 Am
...
Yo no te puedo olvidar`,
  ...
  {
    title: "Me enamore de una zamba",
    slug: "me-enamore-de-una-zamba",
    author: "Los Nocheros",
    letra: `
Bm               (A     G)         F#
La noche iba juntando estrellas dormidas y vi
       Em           (F#      Bm)     Em
pintar la aurora sus rojas mejillas, lento caminar,
Bm               (G) F#                         Bm
Eterno resplandor,   mostraba al sol su inmensidad
(F#m       Bm    A      G) F#  (Em       D)       F#     Bm
 Miraba de reojo celosa la luna sobre la cuna del algarrobal.

Morena y orgullosa de tantas miradas
Llegaba presurosa vistiendo de gala, de misterio
Azul, el rostro se cubrió, donosa
Comenzó a bailar y aprovecho suspiros para       A#
Echar en vuelo blanco pañuelo aromado de azahar.

A                     D
Detrás de ti va mi nostalgia y
 Am     (B )     Em
Agito en vano la esperanza, déjame encender
     Bm             (G)   F#
El fuego de tu candor y en ese sueño verte
Bm          (F#m  Bm      A    G)
Arder así podré saber que destino me
F#   (Em      D)        F#          Bm
Lleva en tu pollera a enredarme de amor.

Intro:Bm,(B ),Em,F#,Bm,(F#,Bm,Em,G,F#),(Em,D),F#,Bm,(F#,Bm)

Deje que mis deseos cobraran altura y en esas gotas de
Rocío bañe tu figura, para ahogar la sed, bebí de la ilusión,
De ser el dueño de tu amor
Soñé que en tu cintura dejaban mis manos
Todo el verano de mi corazón.

Yo quise detenerte paloma en mi
Nido y en un gentil arresto roce tu vestido, pero
Tu ansiedad, buscando el arrebol, dejo su luz de
Eternidad se fue tras de tu huella mi voz al
Nombrarte para entregarte mis ganas de amar
`,
  },
  {
    title: "Perfume de Carnaval",
    slug: "perfume-de-carnaval",
...
Los guardo dentro del alma`,
  ...
  {
    title: "Gallitos del aire",
    slug: "gallitos-del-aire",
    author: "Argentino Luna",
    letra: `
              Em               B7 
Comenzó la zamba y con el pañuelo
                                   Em 
Te invite a bailarla y fue como un ruego
              G                Am 
Cuando te acercaste casi sin aliento
              D7               G   
Con mucha vergüenza dijiste bailemos
           B7                C  
Y asi comenzamos a bailar al zamba
               Am       B7          Em 
...
Gallitos del aire fueron los pañuelos
                   Am       F#7      B7 
Que en  blanco y celeste pintaron mi cielo
            Am       B7        Em 
Ya la media zamba marcaba el final
           F       B7        Em 
Y yo presentia tus ganas de amar

           Em               B7
Se va la segunda dijo el musiquero
                           Em
Y yo enamorado seguia tu vuelo
               G               Am
Presenti tus miedos casi con asombro
          D7               G
Mientras me mirabas por arriba el hombro
         B7                         C
Con la mano izquierda me toco el sombrero
      Am       B7      Em
Como pa decirte aquí hoy de nuevo
...
Se entrelazo al tuyo que andaba volando
         B7                  C
Y fue con el baile violin y guitarra
        Am         B7        Em
...
Gallitos del aire fueron los pañuelos
        Am         F#7       B7
Que blanco y celeste pintaron mi cielo
           Am         B7        Em
Y con el pañuelo te traje hasta mi
       F       B7        Em
Y tu enamorada dijiste que si`,
  },
  {
    title: "Zamba para decir adiós",
    slug: "zamba-para-decir-adios",
    author: "Argentino Luna",
    letra: `
    D       A           D
...
perdona, otra promesa no haré.`,
  ...
  {
    title: "Salteñita de los Valles",
    slug: "saltenita-de-los-valles",
    author: "Horacio Guarany",
    letra: `
    Intro: Am  - A7 - Dm - G7 - C - E7 - Am
...
con vino del moro te'i de machar
                        G     F   E7
ya verás que lindo cuando amanezcas
                  Am
...
ya verás que lindo cuando amanezcas
  ...
  {
    title: "Agitando Pañuelos",
    slug: "agitando-panuelos",
...
Sintiendo también mi pecho agitao
...
como un fantasma cruzaba los días
           B7              F  E
dejándolo todo por sentirte mia
    Am                 Em
...
se fue para siempre mi sueño de amor`,
  ...
  {
    title: "Zamba de tu adiós",
    slug: "zamba-de-tu-adios",
    author: "Los Manseros Santiagueños",
    letra: `
    Am                  G
Soy tu amante trovador
                   F
que al fin se enamoro
       B7      E7
buscando la felicidad
Am                  G
Y de pronto comprendio
                     F
...
la amarga soledad
     E7          Am
que le dejo tu adios

voy andando sin saber
adonde yo me ire
llevandote en mi corazon
Y en silencio tratare
partir desde el ayer
detras de tu presencia
Y no se si llegare
alli donde tal vez
te encuentre donde estas
...
Soy tu amante trovador
que vive la ilusion
de poder verte una vez mas
Aunque nada ya quedo
del fuego y la pasion
que habia en nuestros besos
...
volver adonde fue
la dicha que nacio en los dos
Soy tan solo un trovador
que muere de dolor
y sangra por tu nombre
Hoy la vida me dejo
la pena de este adios
que me alejo de ti`,
  },
  {
    title: "Luna tucumana",
